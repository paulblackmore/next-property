  ...
  return (
    <div className='relative cursor-pointer rounded bg-slate-300 hover:bg-slate-200'>
      <div className='relative h-72'>
        <Image
          fill
          className='relative h-72 object-cover'
      ...
      <div className='h-40 p-4'>
        ...
        <div className='mb-4 mt-4 flex items-center justify-between gap-2 font-semibold'>
          ...
          <div>{`${numberWithCommas(property.square_feet)} sqft`}</div>
        </div>
      </div>
      <div className='absolute bottom-3 left-3 flex items-center justify-start gap-1'>
